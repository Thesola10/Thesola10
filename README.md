...
```math
\mmlToken{ms}[fontfamily="muahaha; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 100vw; opacity: 0.5; background: url('https://github.com/thesola10/thesola10/blob/main/wall.png?raw=true'); pointer-events: none;"]{}
```
